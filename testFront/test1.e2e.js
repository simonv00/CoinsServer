    ...
    describe("Main flow", async () => {
        ...
        it('TC #1 - Se guarda el usuario en la base de datos', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('');
        });
        ...
        it('TC #4 - Se escribe mal el segundo nombre', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('tienes un error en tu segundo nombre');
        });
        ...
        it('TC #5 - Se escribe mal el primer apellido', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('tienes un error en primer apellido');
        });
        ...
        it('TC #6 - Se escribe mal el segundo apellido', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('tienes un error en tu segundo apellido');
        });
        ...
        it('TC #7 - Se escribe mal el correo', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('tienes un error en tu correo');
        });
        ...
        it('TC #8 - Se escribe mal el telefono', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('tienes un error en tu telefono');
        });
        ...
        it('TC #9 - id repetido', async  () => {
            ...
            const error = await $('#error');
            await expect(await error.getText()).toEqual('El id o el correo esta repedito, prueba otro');
        });
